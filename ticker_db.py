...
TICKER_DATABASE = {
    ...
    # --- XTB European UCITS ETFs (UK-listed) ---
    "CSPX.UK — iShares Core S&P 500 UCITS (Acc USD)": "CSPX.L",
    "VUAG.UK — Vanguard S&P 500 UCITS (Acc GBP)": "VUAG.L",
    "VUSA.UK — Vanguard S&P 500 UCITS (Dist GBP)": "VUSA.L",
    "SPY5.UK — SPDR S&P 500 UCITS (Dist GBP)": "SPY5.L",
    "IUSA.UK — iShares S&P 500 UCITS (Dist GBP)": "IUSA.L",
    "IUIT.UK — iShares S&P 500 IT Sector UCITS (Acc USD)": "IUIT.L",
    "EQQQ.UK — Invesco EQQQ Nasdaq-100 UCITS (Dist GBP)": "EQQQ.L",
    "IWDA.UK — iShares Core MSCI World UCITS (Acc USD)": "IWDA.L",
    "SWDA.UK — iShares Core MSCI World UCITS (Acc GBp)": "SWDA.L",
    "HMWO.UK — HSBC MSCI World UCITS": "HMWO.L",
    "ISAC.UK — iShares MSCI ACWI UCITS": "ISAC.L",
    "VWRL.UK — Vanguard FTSE All-World UCITS (Dist GBP)": "VWRL.L",
    "VWRP.UK — Vanguard FTSE All-World UCITS (Acc GBP)": "VWRP.L",
    "EIMI.UK — iShares Core MSCI EM IMI UCITS": "EIMI.L",
    "VFEM.UK — Vanguard FTSE EM UCITS (Dist GBP)": "VFEM.L",
    "IMEA.UK — iShares Core MSCI Europe UCITS": "IMEA.L",
    "VERX.UK — Vanguard FTSE Europe ex-UK UCITS": "VERX.L",
    "IGLT.UK — iShares Core UK Gilts UCITS": "IGLT.L",
    "VGOV.UK — Vanguard UK Govt Bond UCITS": "VGOV.L",
    "AGBP.UK — iShares Core Aggregate Bond UCITS GBP": "AGBP.L",
    "SGLN.UK — iShares Physical Gold": "SGLN.L",
    "INRG.UK — iShares Global Clean Energy UCITS": "INRG.L",
    # --- XTB European UCITS ETFs (DE-listed) ---
    "SXR8.DE — iShares Core S&P 500 UCITS (Acc EUR)": "SXR8.DE",
    "VUAA.DE — Vanguard S&P 500 UCITS (Acc EUR)": "VUAA.DE",
    "VUSA.DE — Vanguard S&P 500 UCITS (Dist EUR)": "VUSA.DE",
    "QDVE.DE — iShares S&P 500 IT Sector UCITS (Acc EUR)": "QDVE.DE",
    "SXRV.DE — iShares Nasdaq 100 UCITS (Acc EUR)": "SXRV.DE",
    "EUNL.DE — iShares Core MSCI World UCITS (Acc EUR)": "EUNL.DE",
    "VWCE.DE — Vanguard FTSE All-World UCITS (Acc EUR)": "VWCE.DE",
    "IS3N.DE — iShares Core MSCI EM IMI UCITS (Acc EUR)": "IS3N.DE",
    "2B7K.DE — iShares MSCI World SRI UCITS (Acc EUR)": "2B7K.DE",
    "IQQH.DE — iShares Global Clean Energy UCITS (EUR)": "IQQH.DE",
    "XDWD.DE — Xtrackers MSCI World UCITS": "XDWD.DE",
    "DBXD.DE — Xtrackers DAX UCITS": "DBXD.DE",
